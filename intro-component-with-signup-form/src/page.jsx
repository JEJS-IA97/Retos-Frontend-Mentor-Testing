...
const Page = () => {
  ...
  <div className="bg-Accent-Blue mobile:h-[90px] mobile:w-[330px] mb-[25px] flex flex-row justify-center items-center text-white pl-[70px] pr-[70px] rounded-xl desktop:h-[60px] desktop:w-[540px] relative z-10">
    <p className="text-center text-[15px]"><span className="font-bold">Try it free 7 days</span> then $20/mo. thereafter</p>
  </div>
  </div>
  ...
  <form onSubmit={handleSubmit} id="registerForm" className="w-[330px] bg-white flex flex-col items-center p-[25px] desktop:p-[40px] gap-[17px] desktop:gap-[22px] rounded-xl mobile:h-full desktop:w-[540px] relative z-10">
    <div className="relative flex flex-col items-end" >
      ...
      className={`mobile:w-[280px] mobile:h-[55px] desktop:w-[460px] border-2 rounded text-[14px] font-semibold text-Dark-Blue pl-5 pr-5 desktop:pr-7 desktop:pl-7 focus:border-black  focus:outline-none  mobile:right-[20px] ${formErrors.first ? 'border-Primary-Red' : 'border-gray-300'}`}/>
    ...
    <div className="relative flex flex-col items-end" >
      ...
      className={`mobile:w-[280px] mobile:h-[55px] desktop:w-[460px] border-2 rounded text-[14px] font-semibold text-Dark-Blue pl-5 pr-5 desktop:pr-7 desktop:pl-7 focus:border-black  focus:outline-none ${formErrors.last ? 'border-Primary-Red' : 'border-gray-300'}`}/>
    ...
    <div className="relative flex flex-col items-end justify-center" >
      ...
      className={`mobile:w-[280px] mobile:h-[55px] desktop:w-[460px] border-2 rounded text-[14px] font-semibold text-Dark-Blue pl-5 desktop:pr-7 desktop:pl-7 pr-5 focus:border-black  focus:outline-none ${formErrors.email ? 'border-Primary-Red' : 'border-gray-300'}`}/>
    ...
    className={`mobile:w-[280px] mobile:h-[55px] desktop:w-[460px] border-2 rounded text-[14px] font-semibold text-Dark-Blue pl-5 pr-5 desktop:pr-7 desktop:pl-7 focus:border-black  focus:outline-none  mobile:right-[20px] ${formErrors.password ? 'border-Primary-Red' : 'border-gray-300'}`}/>
